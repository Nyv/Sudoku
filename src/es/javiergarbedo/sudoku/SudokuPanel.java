        ...
        if (sudoku != null && !Beans.isDesignTime()) {
            ...
            for(int i=0;i<=NUM_COLUMNS;i++){
                if(sudoku.isInInitialPuzzle(rowSelected, colSelected)){
                    ...
                    g.fillRect(CELL_SIZE*i, CELL_SIZE, CELL_SIZE*i, CELL_SIZE);
                }else{
            ...
            for(int i=0;i<=NUM_COLUMNS;i++){
                ...
                g.drawString(String.valueOf(sudoku.getValue(rowSelected, colSelected)), rowSelected, colSelected);
            }
        }
    }
        ...
        if (getRowSelected() != -1 && getColSelected() != -1) {
            if (evt.getKeyChar() >= '0' && evt.getKeyChar() <= '9') {
                ...
                if (sudoku.isFinished()) {
                    ...
                    ResourceBundle bundle = ResourceBundle.getBundle("/Language/en.properties", Locale.getDefault());
                    String msgLevelCompleted = bundle.getString("Nivel completado");
